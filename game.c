...
int main(int argc, char *argv[])
{
    ...
    Game->Platforms = arrNew();
    arrInsert(Game->Platforms, Game->Platforms->Length, newPlatform(0, 550, 800, 50, 0, 128, 0));
    arrInsert(Game->Platforms, Game->Platforms->Length, newPlatform(300, 450, 200, 30, 0, 0, 0));
    arrInsert(Game->Platforms, Game->Platforms->Length, newPlatform(200, 350, 100, 30, 0, 0, 0));
    arrInsert(Game->Platforms, Game->Platforms->Length, newPlatform(350, 250, 100, 30, 0, 0, 0));
    arrInsert(Game->Platforms, Game->Platforms->Length, newPlatform(500, 150, 100, 30, 0, 0, 0));
