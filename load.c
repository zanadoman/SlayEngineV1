...
uint16 loadAdditionalElements(game* Game)
{
    ...
    Game->Platforms->Values[0] = newPlatform(1500, 2550, 1800, 500, 64, 64, 128);
    Game->Platforms->Values[1] = newPlatform(2300, 2450, 200, 30, 16, 16, 32);
    Game->Platforms->Values[2] = newPlatform(2200, 2350, 100, 30, 16, 16, 32);
    Game->Platforms->Values[3] = newPlatform(2350, 2250, 100, 30, 16, 16, 32);
    Game->Platforms->Values[4] = newPlatform(2500, 2150, 100, 30, 16, 16, 32);
