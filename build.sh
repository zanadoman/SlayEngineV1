...
then
    i686-w64-mingw32-gcc -o Builds/Windows/bin.exe $(find . -name '*.c') -mwindows -LSlayEngineV1/Libraries/Windows -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer -lNeoTypes -lcJSON -lm
    if [ $? == 0 ]
    then
